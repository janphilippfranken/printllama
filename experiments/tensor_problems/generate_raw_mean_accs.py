...
def main(args: DictConfig) -> None:
    ...
    def many_problems():
        ...
        for model_name in models:
            ...
            for problem_name in ['attentionproblem', 'trilproblem', 'maskingproblem', 'row-wisemeanproblem', 'maindiagonalproblem']:
        ...
        models = ['codellama-7b-meta', 'codellama-7b-instruct-meta', 'codellama-13b-instruct-meta', 'codellama-34b-instruct-meta', 'huggingfaceh4-zephyr-7b-beta-hf', 'mistral-7b-instruct-v02-hf']
        raw_mean_accs = pd.DataFrame({
            'model' : models,
            'raw_control_accuracies' : overall_control_accuracies,
            'raw_print_accuracies' : overall_print_accuracies
        })
        raw_mean_accs.to_csv('raw_mean_accs.csv')
