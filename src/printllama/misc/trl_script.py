...
class ScriptArguments:
    model_name: Optional[str] = field(default="codellama/CodeLlama-7b-hf", metadata={"help": "the model name"})
    dataset_name: Optional[str] = field(default="b-mc2/sql-create-context", metadata={"help": "the dataset name"})
